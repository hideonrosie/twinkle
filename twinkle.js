...
(function (window, document, $) { // Wrap with anonymous function
	...
	Twinkle.defaultConfig = {
		...
		prodReasonDefault: '',
		logProdPages: false,
		prodLogPageName: 'Nhật trình đề xuất xóa (PROD)',
	
		// CSD
		speedySelectionStyle: 'buttonClick',
		watchSpeedyPages: [ 'c3', 'c5', 'c9', 'c11', 'c13' ],
		markSpeedyPagesAsPatrolled: false,
	
		// these next two should probably be identical by default
		welcomeUserOnSpeedyDeletionNotification: [ 'db', 'c1', 'c2', 'c3', 'c4', 'c6', 'c9', 'c10', 'c11', 'c12', 'c13', 'bv1', 'bv2', 'bv3', 'bv4', 'tt1', 'tt2', 'tt3', 'tt7', 'tt9', 'tt10', 'tl1', 'tl2', 'tv3', 'đh1', 'đh2', 'đh3', 'đh4', 'ctt1', 'ctt2' ],
		notifyUserOnSpeedyDeletionNomination: [ 'db', 'c1', 'c2', 'c3', 'c4', 'c6', 'c9', 'c10', 'c11', 'c12', 'c13', 'bv1', 'bv2', 'bv3', 'bv4', 'tt1', 'tt2', 'tt3', 'tt7', 'tt9', 'tt10', 'tl1', 'tl2', 'tv3', 'đh1', 'đh2', 'đh3', 'đh4', 'ctt1', 'ctt2' ],
		warnUserOnSpeedyDelete: [ 'db', 'c1', 'c2', 'c3', 'c4', 'c6', 'c9', 'c10', 'c11', 'c12', 'c13', 'bv1', 'bv2', 'bv3', 'bv4', 'tt1', 'tt2', 'tt3', 'tt7', 'tt9', 'tt10', 'tl1', 'tl2', 'tv3', 'đh1', 'đh2', 'đh3', 'đh4', 'ctt1', 'ctt2' ],
		...
		speedyLogPageName: 'Nhật trình xóa nhanh (CSD)',
		...
		xfdLogPageName: 'Nhật trình thảo luận xóa (XfD)',
	...
	$.ajax({
		...
		.fail(function () {
			mw.notify('Không thể phân tích cú pháp cấu hình Twinkle của bạn. Vui lòng thiết lập lại cấu hình ở [[Wikipedia:Twinkle/Preferences]].', {type: 'error'});
		})
	...
	// mw.loader.load(scriptpathbefore + "Thành viên:Alphama/userinfo.js" + scriptpathafter);
	...
	Twinkle.makeFindSourcesDiv = function makeSourcesDiv() {
		...
		return $('<div>')
			...
			.append(
				...
				' (',
				makeLink('//www.google.com/search?tbs=bks:1&q=%22' + title + '%22+-wikipedia', 'sách'), ' - ',
				makeLink('//www.google.com/search?tbm=nws&q=%22' + title + '%22+-wikipedia', 'tin tức'), ' - ',
				makeLink('//www.google.com/search?&q=%22' + title + '%22+site:news.google.com/newspapers&source=newspapers', 'báo chí'), ' - ',
				makeLink('//scholar.google.com/scholar?q=%22' + title + '%22', 'học giả'), ' - ',
				makeLink('https://www.google.com/search?safe=off&tbs=sur:fmc&tbm=isch&q=%22' + title + '%22+-site:wikipedia.org+-site:wikimedia.org', 'hình ảnh tự do'), ' - ',
				makeLink('https://www.google.com/custom?hl=en&cx=007734830908295939403%3Agalkqgoksq0&cof=FORID%3A13%3BAH%3Aleft%3BCX%3AWikipedia%2520Reference%2520Search&q=%22' + title + '%22', 'chú thích WP'),
				')', ' - ',
